...
package com.bachelorproject.yasser.findmyfriends.services;
...
public class BluetoothLeService extends Service {
    ...
    // connection change and com.bachelorproject.yasser.findmyfriends.services discovered.
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(final BluetoothGatt gatt, final int status, final int newState) {
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                // Attempts to discover com.bachelorproject.yasser.findmyfriends.services after successful connection.
    ...
    /**
     * Retrieves a list of supported GATT com.bachelorproject.yasser.findmyfriends.services on the connected device. This should be
     * invoked only after {@code BluetoothGatt#discoverServices()} completes successfully.
     *
     * @return A {@code List} of supported com.bachelorproject.yasser.findmyfriends.services.
     */
